...
// gulp.task('importFigmaPixel', function(){
//   return gulp.src('figmaStyles/exports/page1/*.+(png|jpg)')
//   .pipe(gulp.dest('app/images/pixelImages'))
// });

// gulp.task('importFigmaIcons', function(){
//   return gulp.src('figmaStyles/exports/page1/*.+(svg)')
//   .pipe(gulp.dest('app/images/icons'))
// });

// gulp.task('getFigmaExport', gulp.series(
//   'importFigmaIcons',
//   'importFigmaPixel'
// ));
/** End AddImages */
...
// gulp.task('addFigmaJSOutput', function() {
//   return gulp.src('figmaStyles/index.js')
//     .pipe(replace(/export default styles;[^\n]*/g, ''))
